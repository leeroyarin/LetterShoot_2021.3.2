...
namespace Path2D
{
    [CreateAssetMenu(fileName = "GlobalDisplaySettings", menuName = "Path2D/Global Display Settings", order = 1)]
    public class GlobalDisplaySettings : ScriptableObject
    {
        ...
        [Range(0, 10)]
        public float controlLineWidth = 1f;
        ...
        [Range(0, 10)]
        public float bezierLineWidth = 3f;
